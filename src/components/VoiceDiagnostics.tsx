...
export default function VoiceDiagnostics({ voice, phrase, stop, retry }: { voice: VoiceSnapshot; phrase: string; stop: () => void; retry: () => void }) {
  const active = !["idle", "error"].includes(voice.phase);
  return (
