...
type Capability = { key: string; label: string; ready: boolean; detail: string };
type Status = { capabilities: Capability[]; providers: Record<string, boolean>; recentTtsMetrics: { provider: string; ok: boolean; timeToFirstAudioMs: number | null; totalAudioLatencyMs: number }[] };
