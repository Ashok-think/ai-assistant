...
const ALLOWED = new Set([
  ...
  "openrouterKey", "geminiKey", "elevenLabsKey", "ollamaUrl", "permissions", "ttsProvider", "ttsModel", "ttsVoice", "ttsPolicies", "localLatencyTargetMs", "apiLatencyTargetMs", "chatModelMode", "chatProvider", "chatModel", "thinkingModelMode", "thinkingProvider", "thinkingModel",
