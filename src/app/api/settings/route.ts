...
const ALLOWED = new Set([
  ...
  "openrouterKey", "geminiKey", "elevenLabsKey", "ollamaUrl", "permissions", "ttsProvider", "ttsModel", "ttsVoice", "ttsPolicies", "chatModelMode", "chatProvider", "chatModel", "thinkingModelMode", "thinkingProvider", "thinkingModel",
