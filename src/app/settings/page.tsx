      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="panel p-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div><label className="label">Assistant name</label><input className="input" defaultValue={s.assistantName} onBlur={(e) => patch({ assistantName: e.target.value || "Aria", wakeWord: `hey ${(e.target.value || "Aria").toLowerCase()}` })} /></div>
            <div><label className="label">Wake word</label><input className="input" key={s.wakeWord} defaultValue={s.wakeWord} onBlur={(e) => patch({ wakeWord: e.target.value })} /></div>
